...
export const BtnW = ({title}) => {
  return (
    <button className="text-[12px]  px-[10px]  py-2 lg:py-[11px] md:px-[20px] lg:px-[30px] border border-[--border] text-[--second] rounded-full font-semibold  hover:border-[#07745E] duration-200  ">
      {title}
    </button>
  )
}
