...
export const BtnGG = ({title}) => {
  return (
    <button className="text-[12px]   py-2 lg:py-[11px] px-[20px] lg:px-[30px] border border-[--border] hover:bg-[--pri] hover:text-white duration-200 text-[--pri] rounded-full font-semibold  hover:border-[#07745E] duration-200  ">
      {title}
    </button>
  )
}
