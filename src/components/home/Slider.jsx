    ...
    <div className="container mt-[30px] mb-[40px] md:mb-[84px] lg:mb-[120px] relative ">
      ...
      <div className="flex gap-[10px] absolute z- bottom-[-15px] left-1/2 -translate-x-1/2 ">
        <span
          onClick={() => setIsShow(0)}
          className={` ${
            isShow == 0 ? 'w-[76px]  bg-[--text]' : 'w-[6px] bg-[#b9b6bc] '
          } cursor-pointer duration-500 h-[6px] block rounded `}
        ></span>
        <span
          onClick={() => setIsShow(1)}
          className={` ${
            isShow == 1 ? 'w-[76px]  bg-[--text]' : 'w-[6px] bg-[#b9b6bc] '
          } cursor-pointer duration-500 h-[6px] block rounded `}
        ></span>
        <span
          onClick={() => setIsShow(2)}
          className={` ${
            isShow == 2 ? 'w-[76px]  bg-[--text]' : 'w-[6px] bg-[#b9b6bc] '
          } cursor-pointer duration-500 h-[6px] block rounded `}
        ></span>
        <span
          onClick={() => setIsShow(3)}
          className={` ${
            isShow == 3 ? 'w-[76px]  bg-[--text]' : 'w-[6px] bg-[#b9b6bc] '
          } cursor-pointer duration-500 h-[6px] block rounded `}
        ></span>
      </div>
    </div>
