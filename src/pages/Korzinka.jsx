          ...
          <div className="min-w-[236px]">
            <div className="bg-white border border-[--border] rounded-[10px] px-[20px] py-[15px]">
              <span className="flex justify-between items-center pb-[15px] mb-[15px] border-b">
                <span className="text-[12px] md:text-[14px] font-semibold">Итого</span>
                <span className="text-[12px] md:text-[14px] font-semibold">{totalPrice} руб.</span>
              </span>

              <span className="flex justify-between items-center mb-2">
                <span className="text-[12px] font-medium">Товары ({cards.length} шт)</span>
                <span className="text-[12px] font-medium">{totalPrice} руб.</span>
              </span>
